...
if ($action == "logon") {
	...
	$contstr [] = array (
			'<input type="text" name="i_adminname" size="25" maxlength="20" value="">',
			'left',
			'35%' 
	);
	$contstr [] = array (
	...
	$contstr [] = array (
			'<input type="password" name="i_password" size="25" maxlength="20">',
			'left' 
	);
...
<frameset rows="22,*" framespacing="1">
	<frame src="index.php?action=top" name="head" noresize scrolling="no"
		frameborder="0">
	<frameset cols="140,*" framespacing="0">
		<frame src="index.php?action=menu" name="menu" scrolling="yes"
			frameborder="0">
		<frame src="index.php?action=main" name="main" scrolling="yes"
			frameborder="0">
	</frameset>
</frameset>
<noframes></noframes>
...
if ($action == "menu") {
	...
	$contstr = array ();
	$contstr [] = array (
			'<font class="empha">' . $_COOKIE ['adminname'] . '</font>',
			'center' 
	);
	$header = array (
			"管理员",
	...
	$contstr = array ();
	$contstr [] = array (
			'<font class="menu"><a href="test_thread.php?action=edit" target="main">考试列表</a></font><br>' . '<font class="menu"><a href="test_thread.php?action=add" target="main">添加考试</a></font><br>' . '<font class="menu"><a href="test_thread.php?action=setmark" target="main">分数设置</a></font><br>' . '<font class="menu"><a href="test_thread.php?action=loadquestion" target="main">导入试题</a></font><br>' . '<font class="menu"><a href="test_thread.php?action=outputscore" target="main">导出成绩</a></font><br>',
			"left" 
	);
	$header = array (
			'试题管理',
